...
This is a sample template for event-tracker - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name event-tracker --tail
```
...
```bash
aws cloudformation delete-stack --stack-name event-tracker
```
